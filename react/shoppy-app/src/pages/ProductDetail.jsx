...
export function ProductDetail({addCart}) {
    ...
    const tabEventNames = ['detail', 'review', 'qna', 'return'];
        ...
        const filterData = async () => {
            ...
            // setProduct(jsonData.filter((item) => item.pid === pid ));
            // await jsonData.filter((item) => item.pid === pid ? setProduct(item) : null )
            ...
            <div className='product-detail-top'>
                ...
                <ul className='product-detail-info-top'>
                    ...
                    <li className='product-detail-subtitle-star'>
                        <StarRating totalRate={parseFloat(product.rate? product.rate : "0")} style="star-coral" />
                        <span>527개 리뷰 &nbsp;&nbsp; {">"} </span>
                    </li>
                    <li>
                        <p className='product-detail-box'>
                            신규회원, 무이자할부 등
                        </p>
                    </li>
                    <li className='flex'>
                    ...
                    <li className='flex'>
                        <button type='button' className='product-detail-button order'>바로 구매
                        </button>
                        <button type='button' className='product-detail-button cart' onClick={() => {handleAddCartItem()}}>쇼핑백 담기
                        </button>
                        <div type='button' className='gift'>
                            <PiGiftThin />
                            <div className='gift-span'>선물하기
                            </div>       
                        </div>
                    </li>
                    <li>
