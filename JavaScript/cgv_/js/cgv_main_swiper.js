...
async function createSwiper() {
    ...
    //자동으로 순회하는 forEach는 비동기처럼 함수를 호출할 수 없다!!
    //forEach는 동기적인 반복문
    ...
    <div class="swiper">
        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <img src="./img/img.jpg" alt="" class="swiper-img">
            </div>
            <div class="swiper-slide">
                 <img src="./img/img2.jpg" alt="" class="swiper-img">
            </div>
            <div class="swiper-slide">
                 <img src="./img/img3.jpg" alt="" class="swiper-img">
            </div>
            ...
        </div>
